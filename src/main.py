...
from .window import PytimerWindow


class PytimerApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='code.leech.pytimer',
    ...
    def do_activate(self):
        ...
        if not win:
            win = PytimerWindow(application=self)
        win.present()
